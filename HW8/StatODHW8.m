...
for SigPt = 1:2*L+1
 ...
 % --- Time update ---
    ...
    % third mu 
    muThree = [6.8711*10^3;0.0293*10^3;0.0522*10^3;-1.1409*10-4;7.5000;0.1995]; 
    
    % alpha 
    alpha = [0.33, 0.67, 0.33]; 
    ...
    timeIdx = 860;
    Utility.GMMCKFCornerPlot(YmonteCat, Ynom, timeIdx, YLinCov, P, time)