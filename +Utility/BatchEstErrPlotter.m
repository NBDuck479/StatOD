function [threeSigmaStates] = BatchEstErrPlotter(covPlus, NumStates, xhist, fig, obTime, simuTime)
...
sgtitle('Batch Spacecraft Position Estimation Error')
...
sgtitle('Batch Spacecraft Velocity Estimation Error')
...
xlabel('Time [hours]')
sgtitle('$\mu$ , $J_2$ , $C_d$ Batch Estimation Error', 'Interpreter', 'latex')
