function LinCovCornerPlot(YmonteCat, Ynom, timeIdx, YLinCov, P, time)
...
sgtitle(sprintf('LinCov Position Plots at %.2f hours', time(timeIdx)/(60*60)));
...
sgtitle(sprintf('LinCov Velocity Plots at %.2f hours', time(timeIdx)/(60*60)));
...
legend([h1, h2], 'LinCov', 'MonteCarlo', 'Location', 'southeast')
